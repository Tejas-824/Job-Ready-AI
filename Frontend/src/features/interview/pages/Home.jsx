                        ...
                        <div className='panel__header'>
                            <div className='panel__header-left'>
                                ...
                                <div>
                                    ...
                                    <p className='panel__subtext'>Paste the role details for better interview analysis.</p>
                                </div>
                            </div>
                    ...
                    <div className='panel panel--right'>
                        <div className='panel__header'>
                            <div className='panel__header-left'>
                                ...
                                <div>
                                    <h2>Your Profile</h2>
                                    <p className='panel__subtext'>Upload your resume or write a quick self-description.</p>
                                </div>
                            </div>
                        </div>
